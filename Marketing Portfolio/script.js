    ...
    const content = {
        ...
        <div class="navbar scrollbar">
            ...
            <div>
                ...
                <p>Driven by curiosity, I completed the <b>Google Career Certificate in Digital Marketing & E-commerce</b>, where I learned key skills in SEO, SEM, email marketing, and analytics. To complement this, I self-taught programming and built several small projects to better understand websites, user experience, and how digital tools work behind the scenes.</p>
                <p>Today, my goal is to apply this mix of creative, technical, and analytical skills in an entry-level digital marketing role where I can help businesses grow their online presence and connect with their audiences.</p>
        ...
        <div class="projects-container">
          ...
          <div class="project-category">
            ...
            <p>Real-life case studies covering campaign automation, segmentation, and A/B testing.</p>
            <div class="project-grid">
              <div class="project-item">
